    ...
    <div class="container-fluid p-0">
        <div class="row g-0 min-vh-100">
                            ...
                            <div class="card-body">
                                ...
                                <form id="formAuthentication" class="mb-6" method="POST"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <select class="form-select @error('tipe_user') is-invalid @enderror"
                                            id="tipe_user" name="tipe_user">
            ...
            <div class="col-lg-8 d-none d-lg-flex align-items-center justify-content-center bg-primary">
                <img src="{{ asset('template/img/backgrounds/regis.png') }}" alt="Login Illustration"
