                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-6" method="POST" action="{{ route('register') }}">
                            ...
                            <!-- Role (optional: hidden default user) -->
                            ...
                            <div class="mb-6">
                                ...
                                <select class="form-select @error('tipe_user') is-invalid @enderror" id="tipe_user"
                                    ...
                                    <option value="pns" {{ old('tipe_user') == 'pns' ? 'selected' : '' }}>PNS
                                    </option>
                                    <option value="p3k" {{ old('tipe_user') == 'p3k' ? 'selected' : '' }}>P3K
                                    </option>
                                    <option value="magang" {{ old('tipe_user') == 'magang' ? 'selected' : '' }}>Magang
                                    </option>
                                    <option value="cleaning" {{ old('tipe_user') == 'cleaning' ? 'selected' : '' }}>
                                        Cleaning</option>
                                </select>
                                @error('tipe_user')
                                    <small class="text-danger">{{ $message }}</small>
